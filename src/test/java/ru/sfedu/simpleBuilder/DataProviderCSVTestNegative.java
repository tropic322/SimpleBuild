...
import ru.sfedu.simpleBuilder.api.DataProviderCsv;
 ...
 * @author Alexandr
 */
public class DataProviderCSVTestNegative {
    public DataProviderCSVTestNegative() {
    }
    
    private static Logger log = LogManager.getLogger(DataProviderCSVTestNegative.class);
    ...
    public void TestCreateRoofMaterial() {        
        ...
        assertFalse(provider.createRoofMaterial(obj)==Status.SUCCESS);
    ...
    public void TestDeleteRoofMaterial() {
        ...
        assertFalse(provider.delRoofMaterial(obj.getId())==Status.FAULT);
    }
    @Test
    public void TestUpdateRoofMaterial() {
        ...
        assertFalse(provider.updateRoofMaterial(obj2)==Status.SUCCESS);
    }
    @Test
    ...
    public void TestCreateMainPartMaterial() {
        ...
        assertFalse(provider.createMainPartMaterial(obj)==Status.SUCCESS);
    ...
    public void TestDeleteMainPartMaterial() {
        ...
        assertFalse(provider.delMainPartMaterial(obj.getId())==Status.FAULT);
    }
    @Test
    public void TestUpdateMainPartMaterial() {
       ...
       assertFalse(provider.updateMainPartMaterial(obj2)==Status.SUCCESS);
    }
    @Test
    ...
    public void TestCreateBasementMaterial() {
       ...
       assertFalse(provider.createBasementMaterial(obj)==Status.SUCCESS);
    ...
    public void TestDeleteBasementMaterial() {
        ...
        assertFalse(provider.delBasementMaterial(obj.getId())==Status.FAULT);
    }
    @Test
    public void TestUpdateBasementMaterial() {
        ...
        assertFalse(provider.updateBasementMaterial(obj2)==Status.SUCCESS);
    }
    @Test
    ...
    public void TestCreateRoofTemplate() {
       ...
       assertFalse(provider.createRoofTemplate(obj)==Status.SUCCESS);
    ...
    public void TestDeleteRoofTemplate() {
        ...
        assertFalse(provider.delRoofTemplate(obj.getId())==Status.FAULT);
    }
    @Test
    public void TestUpdateRoofTemplate() {
        ...
        assertFalse(provider.updateRoofTemplate(obj2)==Status.SUCCESS);
    }
    @Test
    ...
    public void TestCreateMainPartTemplate() {       
       ...
       assertFalse(provider.createMainPartTemplate(obj)==Status.SUCCESS);
    ...
    public void TestDeleteMainPartTemplate() {
        ...
        assertFalse(provider.delMainPartTemplate(obj.getId())==Status.FAULT);
    }
    @Test
    public void TestUpdateMainPartTemplate() {
        ...
        assertFalse(provider.updateMainPartTemplate(obj2)==Status.SUCCESS);
    }
    @Test
    ...
    public void TestCreateBasementTemplate() {
       ...
       assertFalse(provider.createBasementTemplate(obj)==Status.SUCCESS);
    ...
    public void TestDeleteBasementTemplate() {
        ...
        assertFalse(provider.delBasementTemplate(obj.getId())==Status.FAULT);
    }
    @Test
    public void TestUpdateBasementTemplate() {
        ...
        assertFalse(provider.updateBasementTemplate(obj2)==Status.SUCCESS);
    }
    @Test
    ...
    public void TestCreateBuildingTemplate() {       
       ...
       assertFalse(provider.createBuildingTemplate(obj)==Status.SUCCESS);
    ...
    public void TestDeleteBuildingTemplate() {
        ...
        assertFalse(provider.delBuildingTemplate(obj.getId())==Status.FAULT);
    }
    @Test
    public void TestUpdateBuildingTemplate() {
        ...
        assertFalse(provider.updateBuildingTemplate(obj2)==Status.SUCCESS);
    }
    @Test
