...
import ru.sfedu.simpleBuilder.api.DataProviderJDBC;
...
public class DataProviderJDBCTest {
    ...
    @Test
    public void TestGetRoofMaterial() {
    ...
    @Test
    public void TestGetMainPartMaterial() {
    ...
    @Test
    public void TestGetBasementMaterial() {
    ...
    @Test
    public void TestGetRoofTemplate() {
    ...
    @Test
    public void TestGetMainPartTemplate() {
    ...
    @Test
    public void TestGetBasementTemplate() {
    ...
    public void TestGetByIdBuildingTemplate() {
       ...
       BuildingTemplate obj1 = new BuildingTemplate("test",2,1,1,2,1,1);
       provider.createBuildingTemplate(obj1);
