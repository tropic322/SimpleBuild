 ...
 * @author Alexandr
 */
public class DataProviderXMLTestNegative {
    public DataProviderXMLTestNegative() {
    }
    
    private static Logger log = LogManager.getLogger(DataProviderXMLTestNegative.class);
